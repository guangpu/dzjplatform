...
public abstract class MyActivity extends BaseActivity
    ...
    protected ImmersionBar statusBarConfig() {
        ...
        mImmersionBar = ImmersionBar.with(this)
                ...
                .keyboardMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN|WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN)
        ;
        return mImmersionBar;
    }
...
//        UmengClient.onPause(this);
    ...
    public void showLoading() {
        mStatusManager.showLoading(getContentView());
    }

    public void showLoading(@RawRes int id) {
        mStatusManager.showLoading(getContentView(), id);
    }
    ...
    public void showError() {
        mStatusManager.showError(getContentView(), v -> {
    ...
    public void showError(View.OnClickListener listener) {
        mStatusManager.showError(getContentView(), listener);
    }
    /**
     * 显示自定义提示
     */
    public void showLayout(@DrawableRes int drawableId, @StringRes int stringId, View.OnClickListener listener) {
        mStatusManager.showLayout(getContentView(), drawableId, stringId, listener);
    }
