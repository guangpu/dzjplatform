...
import com.jingchengsoft.dzjplatform.other.PickerLayoutManager;
...
public final class TimeDialog {
    ...
    public static final class Builder
        ...
        public Builder(FragmentActivity activity) {
            ...
            mHourAdapter = new PickerAdapter(activity);
            mMinuteAdapter = new PickerAdapter(activity);
            mSecondAdapter = new PickerAdapter(activity);
            ...
            mHourManager = new PickerLayoutManager.Builder(activity)
                    .build();
            mMinuteManager = new PickerLayoutManager.Builder(activity)
                    .build();
            mSecondManager = new PickerLayoutManager.Builder(activity)
                    .build();
