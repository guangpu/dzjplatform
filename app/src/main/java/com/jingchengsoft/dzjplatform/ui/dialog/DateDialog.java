...
public final class DateDialog {
    ...
    public static final class Builder
        ...
        public Builder(FragmentActivity activity) {
            ...
            mYearAdapter = new PickerAdapter(activity);
            mMonthAdapter = new PickerAdapter(activity);
            mDayAdapter = new PickerAdapter(activity);
            ...
            mYearManager = new PickerLayoutManager.Builder(activity)
                    .build();
            mMonthManager = new PickerLayoutManager.Builder(activity)
                    .build();
            mDayManager = new PickerLayoutManager.Builder(activity)
                    .build();
