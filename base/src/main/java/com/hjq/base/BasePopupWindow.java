...
public class BasePopupWindow extends PopupWindow
    ...
    public static class Builder<B extends BasePopupWindow.Builder> implements ContextAction, ClickAction {
        ...
        public BasePopupWindow showAsDropDown(View anchor) {
            final BasePopupWindow popupWindow = create();
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                popupWindow.showAsDropDown(anchor, mXOffset, mYOffset, mGravity);
            } else {
                popupWindow.showAsDropDown(anchor, mXOffset, mYOffset);
            }
            return popupWindow;
        }
    ...
    private static final class DismissListenerWrapper
            extends WeakReference<PopupWindow.OnDismissListener>
    ...
    public interface OnClickListener<V extends View> {
        void onClick(BasePopupWindow dialog, V view);
    }
